const char *PIDName[]   ={"Varmekilde ", "Konstant    kP", "Konstant    kI", "Konstant    kD", "PID maal    ms", "PID vindu   ms", "PWM% u/Koking ", "Temp. korr.   " , "Hysterese     "};
const char *stageName[] ={"Meske Inn   ", "Phytase   ", "Glucanase ", "Protease  ", "\xE2""Amylase  ", "\xE0""Amylase1 ", "\xE0""Amylase2 ", "Meske Ut  ", "Koking   ", "Kjoling ", "Whirlpool "};
const char *unitName[]  ={"Temp skala  ", "Tempsensor ", "Koke Temp   ", "Koke Temp   ", "Pumpe syklus", "Pumpe pause ", "Pmp Meskeinn", "Pmp Mesking ", "Pmp Meske ut", "Pumpe Koking", "Pumpe Stopp ", "Pumpe Stopp ", "PID Funksjon", "Skip malt in", "Skip malt ut", "Skip Iodine ", "Iodine Tid  " , "Whirlpool   "};
