const char *PIDName[]   ={"Uz  ", "Constanta P", "Constanta I", "Constanta D", "SampleTime ", "Interval ms", "In fierbere", "Calibrare  ", "Histereza  "};
const char *stageName[] ={"Mash In   ", "Fitaza    ", "Glucanaza ", "Proteaza  ", "\xE2""Amilaza  ", "\xE0""Amilaza1 ", "\xE0""Amilaza2 ", "Mash Out  ", "Fierbere  ", "Fierbere  ", "Agitare   "};
const char *unitName[]  ={"Scara Grade  ", "Senzor   ", "Fierbere    ", "Fierbere    ", "Ciclu Pompa  ", "Pauza Pompa   ", "Pmp PreMash", "Pmp la Mash", "Pmp MashOut", "PmpFierbere", "Stop Pompa  ", "Stop Pompa  ", "PID Pipe  " , "Skip Adauga   ", "Skip Elimina", "Skip Iod    ", "Timp Iod ", "Agitare  "};
