const char *PIDName[]   ={"Uso ", "Constante kP", "Constante kI", "Constante kD", "SampleTime ", "Janela  ms  ", "PWM         ", "Calibragem  ", "Histerese  "};
const char *stageName[] ={"Mash In   ", "Fitase    ", "Glucanase ", "Protease  ", "\xE2""Amilase  ", "\xE0""Amilase  ", "\xE0""Amilase2 ", "Mash Out  ", "Ebulicao  ", "Cooling   ", "Whirlpool "};
const char *unitName[]  ={"Escala     ", "Sensor     ", "Ebulicao   ", "Ebulicao   ", "Ciclo Bomba", "Pausa Bomba", "Bmb PreMash", "Bmb em Mash", "Bmb MashOut", "Bomb em Ebu", "Bomb Parada", "Bomb Parada", "PID Pipe  " , "Skip Add      ", "Skip Remove ", "Skip Iodine ", "TempoIodo ", "Whirlpool"};
