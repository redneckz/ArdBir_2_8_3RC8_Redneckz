const char *PIDName[]   ={"Tip ", "Constanta  P", "Constanta  I", "Constanta  D", "SampleTime  ", "Interval ms ", "PWM Fierbere ", "Calibrare   ", "Histereza   "};
const char *stageName[] ={"Mash In   ", "Fitaza    ", "Glucanaza ", "Proteaza  ", "\xE2""Amilaza  ", "\xE0""Amilaza1 ", "\xE0""Amilaza2 ", "Mash Out  ", "Fierbere  ", "Racire    ", "Agitare   "};
const char *unitName[]  ={"Scara Grade", "Senzor     ", "T. Fierbere", "T. Fierbere", "Ciclu Pompa", "Pauza Pompa", "Pmp PreMash", "Pmp la Mash", "Pmp MashOut", "PmpFierbere", "Stop Pompa ", "Stop Pompa ", "PID Pipe   ", "Skip Adauga", "Skip Elimin", "Skip Iod   ", "Timp Iod   ", "Agitare    "};
